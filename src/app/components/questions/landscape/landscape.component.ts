...
export class LandscapeComponent implements OnInit, OnChanges {
    ...
    updateLandscape(): void {
        ...
        // Moon Path: starts rising at progress 0.6 (later half) and arcs up to the peak (left 50%)
        const moonProgress = Math.max(0, (progress - 0.6) / 0.4);
        ...
        const moonOpacity = progress > 0.5 ? 1 : 0;
